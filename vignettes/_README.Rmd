...
World data is retrieved from [EU CDC](https://data.europa.eu/euodp/en/data/dataset/covid-19-coronavirus-data) and is used as the main data source. When there is a delay on the release, we alternatively use [John Hopkin's](https://github.com/CSSEGISandData/COVID-19/).
...
Badge showing problems with report generation: ![https://github.com/averissimo/covid19-analysis/actions](https://github.com/averissimo/covid19-analysis/workflows/.github/workflows/main.yml/badge.svg)
