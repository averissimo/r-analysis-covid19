...
## New cases in Last `r params$last.days` days {.tabset .tabset-fade .tabset-pills}
...
## New cases in Last `r params$last.days` days (per 100k population) {.tabset .tabset-fade .tabset-pills}
