...
```{r}
last.days(my.corona.last.days, 'confirmed', params$last.days, countries, log2.flag = FALSE, per.100k.flag = FALSE, new.flag = TRUE)
```

### Deaths

```{r, warning=FALSE}
last.days(my.corona.last.days, 'death', params$last.days, countries, log2.flag = FALSE, per.100k.flag = FALSE, new.flag = TRUE)
```

### Cases *(log2 scale)*

```{r, message=FALSE, warning=FALSE}
last.days(my.corona.last.days, 'confirmed', params$last.days, countries, log2.flag = TRUE, per.100k.flag = FALSE, new.flag = TRUE)
```

### Deaths

```{r, warning=FALSE}
last.days(my.corona.last.days, 'death', params$last.days, countries, log2.flag = TRUE, per.100k.flag = FALSE, new.flag = TRUE)
```
...
```{r}
last.days.data(my.corona.last.days, 'confirmed') %>% datatable
```
...
```{r}
last.days.data(my.corona.last.days, 'death') %>% datatable
```
...
```{r}
last.days(my.corona.last.days, 'confirmed', params$last.days, countries, log2.flag = FALSE, per.100k.flag = TRUE, new.flag = TRUE)
```

### Deaths

```{r, warning=FALSE}
last.days(my.corona.last.days, 'death', params$last.days, countries, log2.flag = FALSE, per.100k.flag = TRUE, new.flag = TRUE)
```

### Cases *(log2 scale)*

```{r, message=FALSE, warning=FALSE}
last.days(my.corona.last.days, 'confirmed', params$last.days, countries, log2.flag = TRUE, per.100k.flag = TRUE, new.flag = TRUE)
```

### Deaths

```{r, warning=FALSE}
last.days(my.corona.last.days, 'death', params$last.days, countries, log2.flag = TRUE, per.100k.flag = TRUE, new.flag = TRUE)
```
