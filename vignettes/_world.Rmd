...
## per 100k population *(log scale)*

```{r, warning=FALSE}
ommit.start(my.world, 'all', params$confirmed.start, log2.flag = TRUE, per.100k.flag = TRUE, digits = 5)
```
...
```{r}
last.days(my.world.last.days, 'confirmed', params$last.days, c(), log2.flag = FALSE, per.100k.flag = FALSE, new.flag = TRUE)
```
