...
beds.vs.cases2 <- wb.indicator('SH.MED.BEDS.ZS', 'Hospital beds', per.100k = TRUE)
```
...
plot.beds.vs.cases <- function(...) { plot.what.vs.cases(..., data = beds.vs.cases, what = 'Hospital beds') }
```
